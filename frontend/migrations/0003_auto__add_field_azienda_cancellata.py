...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Azienda.cancellata'
        db.add_column('aziende', 'cancellata',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Azienda.cancellata'
        db.delete_column('aziende', 'cancellata')


    models = {
        u'frontend.azienda': {
            'Meta': {'object_name': 'Azienda', 'db_table': "'aziende'"},
            'cancellata': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
